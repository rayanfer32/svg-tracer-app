...
export function ToolkitLink({ href, label }: { href: string; label: string }) {
    return (
        <a
            ...
            className="flex items-center justify-between group p-1 underline rounded-lg border border-slate-100 hover:border-indigo-200 hover:bg-indigo-50/30 transition-all"
        >
